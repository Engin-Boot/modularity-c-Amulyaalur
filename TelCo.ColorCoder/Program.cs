 ...
 class Program

    {
...

        {
            ...
            Colors.ColorPair testPair2 = new Colors.ColorPair() { majorColor = Color.Yellow, minorColor = Color.Green };
            ...
            testPair2 = new Colors.ColorPair() { majorColor = Color.Red, minorColor = Color.Blue };
